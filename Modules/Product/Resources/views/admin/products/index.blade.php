                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{ trans('product::products.table.featureimage') }}</th>
                            ...
                            <?php $path = (count((array)$product->feature_image) > 1) ? $product->feature_image->path : '' ?>
                            <?php echo count((array)$product->feature_image) ?>
                            <tr>
